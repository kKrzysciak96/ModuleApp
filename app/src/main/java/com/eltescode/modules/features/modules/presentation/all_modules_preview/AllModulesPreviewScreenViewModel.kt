...
@HiltViewModel
class AllModulesPreviewScreenViewModel @Inject constructor(private val useCases: ModuleUseCases) :
    ViewModel() {
    ...
    private fun getAllModuleNames() {
        viewModelScope.launch {
            useCases.filterAllModuleNames().collect { namesList ->
                _state.value = state.value.copy(allModules = namesList)
            }
        }
    }
}